...
class HandController(object):
    ...
    def __init__(self, dxl_io, controller_namespace, port_namespace):
        ...
        self.left_side_pressure = UInt8()
        self.right_side_pressure = UInt8()
    ...
    def start(self):
        ...
        # publishers
        self.left_side_pressure_pub = rospy.Publisher(self.controller_namespace + '/left_side_pressure', UInt8, queue_size=50)
        self.right_side_pressure_pub = rospy.Publisher(self.controller_namespace + '/right_side_pressure', UInt8, queue_size=50)
